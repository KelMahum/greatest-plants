...
export const selectModule = {
	...
	getOption(selectOption, originalSelect) {
		...
		selectOptionHTML += selectOptionLink ? `<a ${selectOptionLinkTarget} href="${selectOptionLink}" data-value="${selectOption.value}" class="${selectModule.selectClasses.classSelectOption}${selectOptionClass}${selectOptionSelected}">` : `<button ${selectOptionHide} class="${selectModule.selectClasses.classSelectOption}${selectOptionClass}${selectOptionSelected}" data-value="${selectOption.value}" type="button">`;
